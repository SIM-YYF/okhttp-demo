...
//                .setConverter(new JacksonConverter(new ObjectMapper()))
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Observable request = Observable.create(new Observable.OnSubscribe<Captcha>() {
                    @Override
                    public void call(Subscriber<? super Captcha> subscriber) {

                        subscriber.onNext(service.getCaptcha());
                ...
                request.observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Action1<Captcha>() {
                            @Override
                            public void call(Captcha o) {
                                Toast.makeText(MainActivity2.this, "captcha_id = " + o.captcha_id, Toast.LENGTH_LONG).show();
                        ...
                        .subscribe(new Action1<Response>() {
                            ...
                            public void call(Response  o) {
                                try {
                                    ...
                                    Toast.makeText(MainActivity2.this, "byte[]  length  = " + bodyBytes.length, Toast.LENGTH_LONG).show();
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                ...
                service.getRxStringCaptcha().observeOn(AndroidSchedulers.mainThread())
                        ...
                        .subscribe(new Action1<String>() {
                            ...
                            public void call(String o) {
                                    Toast.makeText(MainActivity2.this, "captcha_id  = " + o.toString(), Toast.LENGTH_LONG).show();
                            }
                        });
            }
        });
